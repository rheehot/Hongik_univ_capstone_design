...
public class user_itembasket_Adpter extends BaseAdapter {
    private Context mContext = null;
    private int layout = 0;
    private ArrayList<user_itembasket_list> data = null;
    private LayoutInflater inflater = null;

    public user_itembasket_Adpter(Context c, int l, ArrayList<user_itembasket_list> d) {
        this.mContext = c;
        this.layout = l;
        this.data = d;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        item_name.setText(data.get(position).item_name);
