...
public class user_itempage_Adpter extends BaseAdapter {
    private Context mContext = null;
    private int layout = 0;
    private ArrayList<user_itempage_list> data = null;
    private LayoutInflater inflater = null;

    public user_itempage_Adpter(Context c, int l, ArrayList<user_itempage_list> d) {
        this.mContext = c;
        this.layout = l;
        this.data = d;
