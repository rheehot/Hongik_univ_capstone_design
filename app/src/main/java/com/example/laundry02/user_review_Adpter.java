...
public class user_review_Adpter extends BaseAdapter {
    private Context mContext = null;
    private int layout = 0;
    private ArrayList<user_review_list> data = null;
    private LayoutInflater inflater = null;

    public user_review_Adpter(Context c, int l, ArrayList<user_review_list> d) {
        this.mContext = c;
        this.layout = l;
        this.data = d;
